...
// If someone is reading this code: I know... many things could have been made better xD
public class MainActivity extends AppCompatActivity implements NumberPicker.OnValueChangeListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        shPref = this.getSharedPreferences("com.myniprojects.memolang", Context.MODE_PRIVATE);
        /// Start functions
        setGuideLine();
        hideNavigationBar();
        getDeckList();
